...
export default async function TVGenrePage({ params, searchParams }: Props) {
  ...
  const baseHref = `/tv/genre/${id}?name=${encodeURIComponent(genreName)}&sort=${sort}&year_min=${yearMin}&year_max=${yearMax}`

  return (
    <div className="min-h-screen pt-24 px-4 md:px-8 pb-16">
      <div className="max-w-7xl mx-auto space-y-6">
        <div>
          <p className="text-gray-500 text-sm uppercase tracking-wide mb-1">TV Shows</p>
